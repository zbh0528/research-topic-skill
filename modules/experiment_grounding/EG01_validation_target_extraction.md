# EG01_validation_target_extraction Validation Target Extraction

## Module ID
`EG01_validation_target_extraction`

## Module Name
Validation Target Extraction

## Purpose
Extract validation targets from contribution claims, final topic package, and optional literature evidence.
...
- `workspaces/<project_id>/experiment_validation/validation_targets.json`
- `workspaces/<project_id>/experiment_validation/validation_targets.md`
