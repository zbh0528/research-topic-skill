# EG04_metric_selection Metric Selection

## Module ID
`EG04_metric_selection`

## Module Name
Metric Selection

## Purpose
Select metrics that directly test each contribution and validation target.
...
- `workspaces/<project_id>/experiment_validation/metric_plan.json`
- `workspaces/<project_id>/experiment_validation/metric_plan.md`
