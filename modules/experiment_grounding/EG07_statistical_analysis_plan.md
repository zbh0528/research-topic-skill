# EG07_statistical_analysis_plan Statistical Analysis Plan

## Module ID
`EG07_statistical_analysis_plan`

## Module Name
Statistical Analysis Plan

## Purpose
Plan statistical tests, independent runs, seeds, effect-size policies, and reporting rules for stochastic comparisons.
...
- `workspaces/<project_id>/experiment_validation/statistical_analysis_plan.json`
- `workspaces/<project_id>/experiment_validation/statistical_analysis_plan.md`
